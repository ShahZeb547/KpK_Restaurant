...
<section id="book-a-table" class="book-a-table">
  <div class="container">
    ...
    <?php
    if(isset($_GET['success'])){
        echo "<div style='color:green;'>Booking Successful!</div>";
    }
    if(isset($_GET['error'])){
    ...
    <form action="process_booking.php" method="post" class="php-email-form">
      ...
      <div class="row">
        ...
        <!-- Client Info -->
        <div class="col-12"><h5>Client Info</h5></div>
        ...
        <div class="col-lg-8 form-group mt-3">
          <label>Home Address</label>
          <input type="text" name="address" class="form-control">
        </div>

        <!-- Booking Info -->
        <div class="col-12 mt-4"><h5>Booking Info</h5></div>
        ...
        <div class="col-lg-3 form-group mt-3">
          ...
          <input type="number" name="numGuest" class="form-control" value="0">
        </div>

        <div class="col-lg-3 form-group mt-3">
          <label>Room/Table Type</label>
          <select id="room_type" name="room_type" class="form-control" required>
            <option value="">Select Option</option>
            <?php
$result = $conn->query("SELECT * FROM roomtables");
while($row = $result->fetch_assoc()){
echo "<option value='{$row['id']}' data-type='{$row['item_category']}'>
{$row['item_type']} ({$row['item_category']} - Rs {$row['price']})
</option>";
}
?>
          </select>
        ...
        <!-- Payment -->
        <div class="col-12 mt-4"><h5>Payment Info</h5></div>
      ...
      <div class="form-group mt-4">
        ...
        <textarea class="form-control" name="special_request" rows="5"></textarea>
      </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>shahzeboffical933@gmail.com</p>
              </div>
...
let category = option.getAttribute("data-type");
...
<?php 
  include 'includes/footer.php'; // Footer file included
?>